...
const initialJobListings = [
  {
    ...
    description:
      "We are seeking an experienced Front-end Developer with expertise in React and Next.js to join our growing team.",
    requirements: [
  ...
  },
  {
    ...
    description:
      "Join our creative team to design beautiful interfaces for our clients' web and mobile applications.",
    requirements: [
  ...
  },
  {
    ...
    description:
      "Looking for a versatile developer who can work on both front-end and back-end technologies.",
    requirements: [
  ...
  },
  {
    ...
    description:
      "We need a talented web designer for a 3-month project creating marketing websites.",
    requirements: [
  ...
  useEffect(() => {
    ...
    if (storedJobs) {
      try {
        ...
        setJobListings(
          initialJobListings.map((job) => ({
            ...job,
            timeframe: "Full-time", // Add missing timeframe property
          }))
        );
      }
    } else {
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center mb-16 slide-in-bottom">
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-xl">
              submit a job or project request if you&apos;re interested in
              hiring me
            </p>
          </div>
            ...
            filteredJobs.map((job) => (
              ...
              >
                <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-6">
                  <div>
                    <h2 className="font-grape-nuts text-2xl mb-2">
                      {job.title}
                    </h2>
                ...
                <div className="mb-6">
                  <h3 className="text-sm uppercase tracking-wider mb-3 text-gray-500">
                    Requirements
                  </h3>
        ...
        <div className="mt-20 border border-gray-200 dark:border-gray-800 p-12 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-lg mx-auto mb-8">
            post your job here and i&apos;ll reach out to you to discuss the
            project
          </p>
